...
import com.urbangear.ecommerceshoes.service.EmailService;
...
public class webController {
    ...
    public String saveOrder(@RequestBody List<order> orderItems, HttpSession session) {
        try {
            ...
            String text = "Thank you for trusting us with your money!";// construct email text;
            ...
            //String userEmail = session.getAttribute(showPayment()); // retrieve user email from session or database;

            emailService.sendOrderConfirmationEmail(userEmail, subject, text);
